        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div id="main-content" style="padding: 40px; ">
                    <form method="post" action="?controller=khuyenmai&action=createKhuyenMai">
                        <h1>Thêm mới khuyến mãi</h1>
                        
                        <label>Tên khuyến mãi</label>
                        <input type="text" name="tenKhuyenMai" required/> <br>
                        ...
                        <label>Tỷ lệ</label>
                        <input type="number" name="tyLe" required/> <br>
