        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div id="main-content" style="padding: 40px; ">
                    <form method="post" action="?controller=khuyenmai&action=updateKhuyenMai&id=<?php echo $_GET['id']; ?>">
                        <h1>Chỉnh sửa khuyến mãi</h1>
                        
                        <label>Tên khuyến mãi</label>
                        <input type="text" name="tenKhuyenMai" value="<?= $khuyenmai->TenKhuyenMai ?>" required/> <br>

                        <label>Ngày bắt đầu</label>
                        <input type="date" name="ngayBatDau" value="<?= $khuyenmai->NgayBatDau ?>" required/> <br>
                        
                        <label>Ngày kết thúc</label>
                        <input type="date" name="ngayKetThuc" value="<?= $khuyenmai->NgayKetThuc ?>"required/> <br>
                        
                        <label>Tỷ lệ</label>
                        <input type="number" name="tyLe" value="<?= $khuyenmai->TyLe ?>"required/> <br>
