            ...
            <div id="content">
                ...
                <div id="main-content" style="padding: 40px; ">
                        ...
                        <tbody>
                            <?php foreach ($loai as $loai): ?>
                                <tr>
                                    ...
                                    <td><?php echo date("d-m-Y H:i:s", strtotime($loai->Created_at)) ?></td>
                                    <td>
                                        <a href="?controller=loai&action=update&id=<?php echo $loai->MaLoai ?>" class="btn btn-success">Sửa</a>
                                        <a href="?controller=loai&action=delete&id=<?php echo $loai->MaLoai ?>" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa <?php echo $loai->TenLoai ?> này không?')">Xóa</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <br>
                            <td colspan="12">Không có Loại được tìm thấy</td>
                        </tr>
                    <?php endif; ?>
