            ...
            <div id="content">
                ...
                <div id="main-content" style="padding: 40px; ">
                        ...
                        <tbody>
                            <?php foreach ($nguoidung as $nguoidung): ?>
                                <tr>
                                    ...
                                    <td><?php echo date("d/m/Y", strtotime($nguoidung->NgaySinh)) ?></td>
                                    ...
                                    <td>
                                        <?php 
                                            ...
                                            if($trangThai == 1) {
                                                echo '<span style="color: green; font-weight: bold;">' . 'Đang hoạt động' . '</span>';
                                            } else {
                                                echo '<span style="color: red; font-weight: bold;">' . 'Đã khóa' . '</span>';    
                                            }
                                        ?>
                                    </td>
                                    <td><?php echo date("d/m/Y H:i:s", strtotime($nguoidung->Created_at)) ?></td>
                                    <td>
                                        <a href="?controller=nguoidung&action=update&id=<?php echo $nguoidung->MaNguoiDung; ?>" class="btn btn-success">Sửa</a>
                                        <a href="?controller=nguoidung&action=delete&id=<?php echo $nguoidung->MaNguoiDung; ?>" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa user <?php echo $nguoidung->HoTen ?> này không?')">Xóa</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <br>
                            <td colspan="12">Không có người dùng được tìm thấy</td>
                        </tr>
                    <?php endif; ?>
                </div>
                <!-- /.container-fluid -->
