        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseQLDanhMuc" class="collapse" aria-labelledby="headingUtilities"
                     data-parent="#accordionSidebar">
                    <div class="bg-gradient-success py-2 collapse-inner rounded">
                        <a class="collapse-item" href="#">Xem danh mục</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseQLBrand" class="collapse" aria-labelledby="headingUtilities"
                     data-parent="#accordionSidebar">
                    <div class="bg-gradient-success py-2 collapse-inner rounded">
                        <a class="collapse-item" href="#">Xem thương hiệu</a>
                        <a class="collapse-item" href="#">Thêm mới</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseQLVaiTro" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-gradient-success py-2 collapse-inner rounded">
                        <a class="collapse-item" href="#">Xem vai trò</a>
                        <a class="collapse-item" href="#">Thêm mới</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseQLKhuyenMai" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-gradient-success py-2 collapse-inner rounded">
                        <a class="collapse-item" href="#">Xem khuyến mãi</a>
                        <a class="collapse-item" href="#">Thêm mới</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div id="main-content" style="padding: 40px; ">
                    <form method="post" action="?controller=nguoidung&action=updateUser&id=<?php echo $_GET['id'] ?>">;
                        <h1>Chỉnh sửa người dùng</h1>
                        <div class="left-section">
                            <label>Họ tên</label>
                            <input type="text" name="hoTen" value="<?= $nguoidung->HoTen ?>" required/> <br>
                            
                            <label>Ngày sinh</label>
                            <input type="date" name="ngaySinh" value="<?= $nguoidung->NgaySinh ?>"required/> <br>
                            ...
                            <label>Địa chỉ</label>
                            <input type="text" name="diaChi" value="<?= $nguoidung->DiaChi ?>"required/> <br>
                        </div>
                        <div class="right-section">
                            <label>Số điện thoại</label>
                            <input type="text" name="sdt" value="<?= $nguoidung->SDT ?>" required/> <br>

                            <label>Email</label>
                            <input type="email" name="email" value="<?= $nguoidung->Email ?>" required/> <br>

                            <label>Mật khẩu</label>
                            <input type="password" name="password" required/> <br>

                            <label>Vai trò</label>
                            <select name="maVaiTro" required>
                                <?php foreach ($vaitro as $vaitro): ?>
                                    <option hidden>Chọn</option>
                                    <option value="<?php echo $vaitro->MaVaiTro; ?>" <?php if ($nguoidung->MaVaiTro == $vaitro->MaVaiTro) echo 'selected'; ?> ><?php echo $vaitro->TenVaiTro; ?></option>
                                <?php endforeach; ?>
                            </select> <br>
                        </div>
