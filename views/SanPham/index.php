    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div id="main-content" style="padding: 40px; overflow-x: auto;">
                        ...
                        <tbody>
                            <?php foreach ($sanpham as $sanpham): ?>
                                <tr>
                                    ...
                                    <td><img src="views/assets/img/sanpham/<?php echo $sanpham->HinhAnhChinh; ?>" height="80" width="100"/></td>
                                    <td><?php echo $sanpham->MoTa ?></td>
                                    <td><?php echo $sanpham->Gia ?></td>
                                    <td><?php echo $sanpham->LoaiDa ?></td>
                                    <td><?php echo $sanpham->GioiTinh ?></td>
                                    <td><?php echo $sanpham->VanDeVeDa ?></td>
                                    <td><?php echo $sanpham->ThanhPhanChinh ?></td>
                                    <td><?php echo $sanpham->ThanhPhanChiTiet ?></td>
                                    <td><?php echo $sanpham->SoLuongTon ?></td>
                                    <td><?php echo $sanpham->TenThuongHieu ?></td>
                                    <td><?php echo $sanpham->TenLoai ?></td>
                                    <td><?php echo $sanpham->TenKhuyenMai ?></td>
                                    <td><?php echo date("d/m/Y H:i:s", strtotime($sanpham->Created_at)) ?></td>
                                    <td>
                                        <a href="?controller=sanpham&action=update&id=<?php echo $sanpham->MaSanPham ?>" class="btn btn-success">Sửa</a>
                                        <a href="?controller=sanpham&action=delete&id=<?php echo $sanpham->MaSanPham ?>" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa <?php echo $sanpham->TenSanPham ?> này không?')">Xóa</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <br>
                            <td colspan="12">Không có sản phẩm được tìm thấy</td>
                        </tr>
                    <?php endif; ?>
                </div>
                <!-- /.container-fluid -->
