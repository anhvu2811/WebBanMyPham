        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div id="main-content" style="padding: 40px; ">
                    <form method="post" action="?controller=thuonghieu&action=createThuongHieu">
                        <h1>Thêm mới thương hiệu</h1>
                        
                        <label>Tên thương hiệu</label>
                        <input type="text" name="tenThuongHieu" required/> <br>
                        
                        <label>Xuất xứ</label>
                        <input type="text" name="xuatXu" required/> <br>
