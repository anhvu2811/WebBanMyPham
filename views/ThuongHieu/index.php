            ...
            <div id="content">
                ...
                <div id="main-content" style="padding: 40px; ">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php foreach ($thuonghieu as $thuonghieu): ?>
                                <tr>
                                    <td><?php echo $thuonghieu->MaThuongHieu; ?></td>
                                    <td><?php echo $thuonghieu->TenThuongHieu; ?></td>
                                    <td><?php echo $thuonghieu->XuatXu; ?></td>
                                    <td><?php echo date("d/m/Y H:i:s", strtotime($thuonghieu->Created_at)) ?></td>
                                    <td>
                                        <a href="?controller=thuonghieu&action=update&id=<?php echo $thuonghieu->MaThuongHieu ?>" class="btn btn-success">Sửa</a>
                                        <a href="?controller=thuonghieu&action=delete&id=<?php echo $thuonghieu->MaThuongHieu ?>" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa <?php echo $thuonghieu->TenThuongHieu ?> này không?')">Xóa</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <br>
                            <td colspan="12">Không có thương hiệu được tìm thấy</td>
                        </tr>
                    <?php endif; ?>
                </div>
                <!-- /.container-fluid -->
