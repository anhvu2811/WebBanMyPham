        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div id="main-content" style="padding: 40px; ">
                    <form method="post" action="?controller=thuonghieu&action=updateThuongHieu&id=<?php echo $_GET['id']; ?>">
                        <h1>Chỉnh sửa thương hiệu</h1>
                        
                        <label>Tên thương hiệu</label>
                        <input type="text" name="tenThuongHieu" value="<?= $thuonghieu->TenThuongHieu ?>"required/> <br>
                        
                        <label>Xuất xứ</label>
                        <input type="text" name="xuatXu" value="<?= $thuonghieu->XuatXu ?>"required/> <br>
