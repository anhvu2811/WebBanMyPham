            ...
            <div id="content">
                ...
                <div id="main-content" style="padding: 40px; ">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php foreach ($vaitro as $vaitro): ?>
                                <tr>
                                    <td><?php echo $vaitro->MaVaiTro; ?></td>
                                    <td><?php echo $vaitro->TenVaiTro; ?></td>
                                    <td><?php echo $vaitro->MoTa; ?></td>
                                    <td><?php echo date("d/m/Y H:i:s", strtotime($vaitro->Created_at)) ?></td>
                                    <td style="color: red;">
                                        <a href="?controller=vaitro&action=update&id=<?php echo $vaitro->MaVaiTro ?>" class="btn btn-success">Sửa</a> 
                                        <a href="?controller=vaitro&action=delete&id=<?php echo $vaitro->MaVaiTro ?>" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa <?php echo $vaitro->TenVaiTro ?> này không?')">Xóa</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <br>
                            <td colspan="12">Không có vai trò được tìm thấy</td>
                        </tr>
                    <?php endif; ?>
