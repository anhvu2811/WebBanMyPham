        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div id="main-content" style="padding: 40px; ">
                    <form method="post" action="?controller=vaitro&action=updateVaiTro&id=<?php echo $_GET['id']; ?>">
                        <h1>Chỉnh sửa vai trò</h1>
                        
                        <label>Tên vai trò</label>
                        <input type="text" name="tenVaiTro" value="<?= $vaitro->TenVaiTro ?>" required/> <br>
                        
                        <label>Mô tả</label>
                        <input type="text" name="moTa" value="<?= $vaitro->MoTa ?>" required/> <br>
